...
import { WORLD_COUNTRY_PATHS, WorldCountryPath } from "@/lib/geo/worldAtlas";
import { getFullCountryName, getContinentForCountry } from "@/lib/countries";
...
export default function WorldMapAnalytics({
  ...
  const countryDataMap = useMemo(() => {
    ...
    (countries || []).forEach((c) => {
      ...
      if (codeUpper) map.set(codeUpper, c);
      if (c.country && typeof c.country === "string") {
